...
for k in OPENAI_API_KEY FIBER_API_KEY VAPI_API_KEY DEEPGRAM_API_KEY SMALLEST_API_KEY \
         COMPOSIO_API_KEY SLACK_CHANNEL AGENTMAIL_API_KEY HYDRADB_API_KEY FIRECRAWL_API_KEY; do
  set_server "$k"
done
