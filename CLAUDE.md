# Quorum Context For Claude Code

Read `AGENTS.md` first. It is the source of truth for product direction, design rules, routes, recent work, and validation commands.

Current handoff summary:
- Quorum is moving from hackathon prototype to sellable AI-first account execution product.
